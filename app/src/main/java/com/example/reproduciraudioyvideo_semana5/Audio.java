...
public class Audio extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vectormp[0] = MediaPlayer.create(this,R.raw.callaita);
        vectormp[1] = MediaPlayer.create(this,R.raw.adoreyou);
        vectormp[2] = MediaPlayer.create(this,R.raw.letmeloveyou);
    }
